...
<div id="contact">
  ...
  <div class="fields">
    ...
    <input type="text" name="name" id="full-name" placeholder="First and Last" style="background-color:Orange;" required="">
    </div>      
    <div class="field">
    <label for="email-address" style="color: green;">Email: </label>
    <input type="email" name="_replyto" id="email-address" placeholder="email@domain.tld" style="background-color:Orange;" required="" >
    </div>  
    <div class="field">
    <label for="message" style="color: green;">Message: </label>
    <textarea rows="5" name="message" id="message" placeholder="Type your message" style="background-color:Orange;" required=""></textarea>
